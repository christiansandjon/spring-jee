...
public class ListeAFS {
	...
	// ajouter liste 
	public void ajouterListe(String user, String description, Date date, boolean estEffectuee) {
		liste.add(new ListeAF(++totalListed,user,description,date,estEffectuee));
	}
